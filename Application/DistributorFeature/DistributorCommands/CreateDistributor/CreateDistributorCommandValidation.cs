...
namespace Application.DistributorFeature.DistributorCommands.CreateDistributor
{
    public class CreateDistributorCommandValidation : AbstractValidator<CreateDistributorCommand>
    {
        public CreateDistributorCommandValidation()
        {
            ...
            RuleFor(x => x.Distributor.FirstName).NotEmpty().MaximumLength(50).WithMessage("Uncorrect FirstName format");
            RuleFor(x => x.Distributor.LastName).NotEmpty().MaximumLength(50).WithMessage("Uncorrect LastName format");
            ...
            RuleFor(x => x.Distributor.IdInformation.IdNumber).NotEmpty().MaximumLength(50).WithMessage("Uncorrect IdNumber format");
